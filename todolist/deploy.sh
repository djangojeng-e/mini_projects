# !/usr/bin/env sh 
IDENTIFY_FILE="$HOME/.ssh/newtodolist.pem"
HOST="ubuntu@15.164.97.104"
ORIGIN_SOURCE="$HOME/mini_projects/todolist/"
DEST_SOURCE="/home/ubuntu/projects/todolist"
...
# pip install 
echo "pip install"
${SSH_CMD} pip3 install -q -r /home/ubuntu/projects/todolist/requirements.txt
...
# 실행중인 세션에 명령어 전달 
${SSH_CMD} -C "screen -r runserver -X stuff 'sudo python3 /home/ubuntu/projects/todolist/manage.py runserver 0:80\n'"
